...
public class FenceGateBlockBase extends FenceGateBlock implements Registerable, ClientItemInitialization {
    ...
    public FenceGateBlockBase(ModX mod, Properties properties, Item.Properties itemProperties) {
        ...
        this.item = new BlockItem(this, itemProperties) {
            ...
            public void initializeClient(@Nonnull Consumer<IItemRenderProperties> consumer) {
                FenceGateBlockBase.this.initializeItemClient(consumer);
            }
        };
    }
