...
public abstract class BlockStateProviderBase extends ModelProvider {
    ...
    @Nullable
    private Identifier currentRenderTypes = null;
    @Nullable
     ...
     */
    protected void setRenderType(@Nullable Identifier renderTypes) {
    ...
    protected void defaultState(Identifier id, Block block, Supplier<Identifier> model) {
        ...
        if (block instanceof DecoratedWoodBlock decorated) {
            ...
            Identifier bottom = this.createBlockModel(blockModelId(id), ModelTemplates.SLAB_BOTTOM, mapping, this.currentRenderTypes);
            Identifier top = this.createBlockModel(blockModelId(id, "_top"), ModelTemplates.SLAB_TOP, mapping, this.currentRenderTypes);
            ...
            Identifier texture = textureId(Objects.requireNonNull(BuiltInRegistries.BLOCK.getKey(decorated.parent)));
            TextureMapping mapping = new TextureMapping().put(TextureSlot.BOTTOM, texture).put(TextureSlot.TOP, texture).put(TextureSlot.SIDE, texture);
            Identifier inner = this.createBlockModel(blockModelId(id, "_inner"), ModelTemplates.STAIRS_INNER, mapping, this.currentRenderTypes);
            Identifier straight = this.createBlockModel(blockModelId(id), ModelTemplates.STAIRS_STRAIGHT, mapping, this.currentRenderTypes);
            Identifier outer = this.createBlockModel(blockModelId(id, "_outer"), ModelTemplates.STAIRS_OUTER, mapping, this.currentRenderTypes);
            ...
            Identifier signModel = this.createBlockModel(blockModelId(id), ModelTemplates.PARTICLE_ONLY, TextureMapping.particle(particle), this.currentRenderTypes);
    ...
    public void buttonBlock(Block block, Identifier texture) {
        ...
        Identifier model = this.createBlockModel(blockModelId(block), ModelTemplates.BUTTON, mapping, this.currentRenderTypes);
        Identifier pressed = this.createBlockModel(blockModelId(block, "_pressed"), ModelTemplates.BUTTON_PRESSED, mapping, this.currentRenderTypes);
    ...
    public void pressurePlateBlock(Block block, Identifier texture) {
        TextureMapping mapping = TextureMapping.singleSlot(TextureSlot.TEXTURE, texture);
        Identifier model = this.createBlockModel(blockModelId(block), ModelTemplates.PRESSURE_PLATE_UP, mapping, this.currentRenderTypes);
        Identifier pressed = this.createBlockModel(blockModelId(block, "_down"), ModelTemplates.PRESSURE_PLATE_DOWN, mapping, this.currentRenderTypes);
    ...
    public void wallBlock(Block block, Identifier texture) {
        ...
        Identifier post = this.createBlockModel(blockModelId(block, "_post"), ModelTemplates.WALL_POST, mapping, this.currentRenderTypes);
        Identifier low = this.createBlockModel(blockModelId(block, "_side"), ModelTemplates.WALL_LOW_SIDE, mapping, this.currentRenderTypes);
        Identifier tall = this.createBlockModel(blockModelId(block, "_side_tall"), ModelTemplates.WALL_TALL_SIDE, mapping, this.currentRenderTypes);
    ...
    public void fenceBlock(Block block, Identifier texture) {
        TextureMapping mapping = TextureMapping.singleSlot(TextureSlot.TEXTURE, texture);
        Identifier post = this.createBlockModel(blockModelId(block, "_post"), ModelTemplates.FENCE_POST, mapping, this.currentRenderTypes);
        Identifier side = this.createBlockModel(blockModelId(block, "_side"), ModelTemplates.FENCE_SIDE, mapping, this.currentRenderTypes);
    ...
    public void fenceGateBlock(Block block, Identifier texture) {
        TextureMapping mapping = TextureMapping.singleSlot(TextureSlot.TEXTURE, texture);
        Identifier open = this.createBlockModel(blockModelId(block, "_open"), ModelTemplates.FENCE_GATE_OPEN, mapping, this.currentRenderTypes);
        Identifier closed = this.createBlockModel(blockModelId(block), ModelTemplates.FENCE_GATE_CLOSED, mapping, this.currentRenderTypes);
        Identifier wallOpen = this.createBlockModel(blockModelId(block, "_wall_open"), ModelTemplates.FENCE_GATE_WALL_OPEN, mapping, this.currentRenderTypes);
        Identifier wallClosed = this.createBlockModel(blockModelId(block, "_wall"), ModelTemplates.FENCE_GATE_WALL_CLOSED, mapping, this.currentRenderTypes);
    ...
    public void doorBlockWithRenderType(Block block, Identifier bottom, Identifier top, Identifier renderType) {
        TextureMapping mapping = TextureMapping.door(top, bottom);
        Identifier bl = this.createBlockModel(blockModelId(block, "_bottom_left"), ModelTemplates.DOOR_BOTTOM_LEFT, mapping, renderType);
        Identifier blo = this.createBlockModel(blockModelId(block, "_bottom_left_open"), ModelTemplates.DOOR_BOTTOM_LEFT_OPEN, mapping, renderType);
        Identifier br = this.createBlockModel(blockModelId(block, "_bottom_right"), ModelTemplates.DOOR_BOTTOM_RIGHT, mapping, renderType);
        Identifier bro = this.createBlockModel(blockModelId(block, "_bottom_right_open"), ModelTemplates.DOOR_BOTTOM_RIGHT_OPEN, mapping, renderType);
        Identifier tl = this.createBlockModel(blockModelId(block, "_top_left"), ModelTemplates.DOOR_TOP_LEFT, mapping, renderType);
        Identifier tlo = this.createBlockModel(blockModelId(block, "_top_left_open"), ModelTemplates.DOOR_TOP_LEFT_OPEN, mapping, renderType);
        Identifier tr = this.createBlockModel(blockModelId(block, "_top_right"), ModelTemplates.DOOR_TOP_RIGHT, mapping, renderType);
        Identifier tro = this.createBlockModel(blockModelId(block, "_top_right_open"), ModelTemplates.DOOR_TOP_RIGHT_OPEN, mapping, renderType);
    ...
    public void trapdoorBlockWithRenderType(Block block, Identifier texture, boolean orientable, Identifier renderType) {
        TextureMapping mapping = TextureMapping.singleSlot(TextureSlot.TEXTURE, texture);
        Identifier top;
        Identifier bottom;
        Identifier open;
    ...
    protected Identifier createBlockModel(Identifier modelId, ModelTemplate template, TextureMapping mapping, @Nullable Identifier renderType) {
    ...
    public static class RenderTypes {
        ...
        public static final Identifier SOLID = Identifier.fromNamespaceAndPath("minecraft", "solid");
        public static final Identifier CUTOUT = Identifier.fromNamespaceAndPath("minecraft", "cutout");
        public static final Identifier CUTOUT_MIPPED = Identifier.fromNamespaceAndPath("minecraft", "cutout_mipped");
        public static final Identifier CUTOUT_MIPPED_ALL = Identifier.fromNamespaceAndPath("minecraft", "cutout_mipped_all");
        public static final Identifier TRANSLUCENT = Identifier.fromNamespaceAndPath("minecraft", "translucent");
        public static final Identifier TRIPWIRE = Identifier.fromNamespaceAndPath("minecraft", "tripwire");
    }
}
